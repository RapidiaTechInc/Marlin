...
#ifdef RAPIDIA_METAL
  #define HOMING_BUMP_MM      { 2.0, 2.0, 1.0 }       // (mm) Backoff from endstops after first bump
  #define HOMING_BUMP_DIVISOR { 10, 10, 10 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
  // DIVISOR for Z Probe is actually Z_PROBE_SPEED_SLOW in Configuration.h for some weird reason
#else // RAPIDIA_PLASTIC
  #define HOMING_BUMP_MM      { 5.0, 5.0, 2.0 }
