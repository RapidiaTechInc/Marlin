...
// PWM for HEATER_2_PIN
  ...
  case 'R':
    ...
    case 710:
      R710();
      break; // R710: set timer
    case 711:
      R711();
      break; // timer-predicate conditional execution
#endif

#if ENABLED(RAPIDIA_LINE_AUTO_REPORTING)
    case 730:
      R730();
      break; // R730: enable report on line finish
    case 731:
      R731();
      break; // R731: disable report on line finish
#endif

#if ENABLED(RAPIDIA_CHECKSUMS)
    case 732:
      R732();
      break; // R732: i/o serial checksum mode.
#endif
    ...
    case 734:
      R734();
      break; // R734: begin z-max recording
#endif
    case 735:
      R735();
      break; // R735: z-max hysteresis threshold
#endif

#if ENABLED(RAPIDIA_HEARTBEAT)
    case 738:
      R738();
      break; // R738: set heartbeat interval and flags
    case 739:
      R739();
      break; // R739: immediate heartbeat
#endif

#if ENABLED(RAPIDIA_LAMP_ALIAS)
    case 736:
      M106();
      break; // R736: alias for M106
    case 737:
      M107();
      break; // R737: alias for M107
#endif

#if ENABLED(USB_FLASH_DRIVE_SUPPORT)
    case 740:
      R740();
      break; // R740: check for usb flash drive
#endif

#if ENABLED(RAPIDIA_MILEAGE)
    case 741:
      R741();
      break; // R741: reset mileage
    case 742:
      R742();
      break; // R742: save mileage immediately
    case 743:
      R743();
      break; // R743: set mileage save interval
    case 744:
      R744();
      break; // R743: edit mileage directly
#endif

#if ENABLED(RAPIDIA_HOMING_RESET)
    case 745:
      R745();
      break; // R745: reset homing status
#endif
    ...
    case 750:
      hard_reset();
      break; // R750: immediately reset printer (also parsed by e_parser)
#endif
    ...
    case 751:
      R751();
      no_ok = true;
      break; // R751: pause (soft)
    case 752:
      R752();
      no_ok = true;
      break; // R752: pause (firm)
#else
    case 751:
    case 752:
      no_ok = true;
    ...
    case 753:
      hard_reset_bl();
      break; // R753: reset to bootloader (also parsed by e_parser)
#endif
    ...
    case 800:             // R800: infinite loop
      ...
      break;
    case 801:
      break; // (emergency parser handles this)
    case 802:
      R802();
