...
#define STR_ERR_LINE_NO                     "Line Number is not Last Line Number+1"
#define STR_ERR_CHECKSUM_MISMATCH           "checksum mismatch"
#define STR_ERR_NO_CHECKSUM                 "No Checksum with line number"
#define STR_ERR_MISSING_CHECKSUM            "Checksum missing"
#define STR_ERR_LAST_LINE                   ", Last Line: "
