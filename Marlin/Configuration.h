...
//#define PARKING_EXTRUDER
  ...
  #define HOTEND_OFFSET_Z { 0.0, 1.2 }                // Z-offsets of the two hotends. The first must be 0.
#endif
...
#define HOTEND_OFFSET_X {0.0, 250.00} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define TEMP_BED_HYSTERESIS 0.5     // (degC) range of +/- temperatures considered "close" to the target one
#define TEMP_BED_WINDOW     2.5     // (degC) Window around target to start the residency timer x degC early.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1250, 1250, 80, 800 }
